      ...
      <div className="mx-auto w-full max-w-3xl px-4 py-8 sm:px-6">
        <div className="mb-8 flex items-center justify-between gap-3">
          ...
          <button
            type="button"
            onClick={() => {
              if (mathSetupExpanded || spellingSetupExpanded || sentenceSetupExpanded) {
                setMathSetupExpanded(false);
                setSpellingSetupExpanded(false);
                setSentenceSetupExpanded(false);
              }
            }}
            disabled={!(mathSetupExpanded || spellingSetupExpanded || sentenceSetupExpanded)}
            className={cn(
              "rounded-full border px-4 py-2 text-sm font-semibold transition",
              mathSetupExpanded || spellingSetupExpanded || sentenceSetupExpanded
